...
VALUES
    ...
    (5, 'fa', 'سیستم‌های طراحی', 'design-systems', NULL, '[]', 'سیستم‌های طراحی', NOW(), NOW()),
    (5, 'ar', 'أنظمة التصميم', 'design-systems', NULL, '[]', 'أنظمة التصميم', NOW(), NOW()),
    (6, 'en', 'App design', 'app-design', NULL, '[]', 'App design', NOW(), NOW()),
    (6, 'fa', 'طراحی اپلیکیشن', 'app-design', NULL, '[]', 'طراحی اپلیکیشن', NOW(), NOW()),
    (6, 'ar', 'تصميم التطبيقات', 'app-design', NULL, '[]', 'تصميم التطبيقات', NOW(), NOW()),
    (7, 'en', 'Brand strategy', 'brand-strategy', NULL, '[]', 'Brand strategy', NOW(), NOW()),
    (7, 'fa', 'استراتژی برند', 'brand-strategy', NULL, '[]', 'استراتژی برند', NOW(), NOW()),
    (7, 'ar', 'استراتيجية العلامة التجارية', 'brand-strategy', NULL, '[]', 'استراتيجية العلامة التجارية', NOW(), NOW()),
    (8, 'en', 'UI/UX design', 'ui-ux-design', NULL, '[]', 'UI/UX design', NOW(), NOW()),
    (8, 'fa', 'طراحی رابط و تجربهٔ کاربری', 'ui-ux-design', NULL, '[]', 'طراحی رابط و تجربهٔ کاربری', NOW(), NOW()),
    (8, 'ar', 'تصميم الواجهة وتجربة المستخدم', 'ui-ux-design', NULL, '[]', 'تصميم الواجهة وتجربة المستخدم', NOW(), NOW()),
    (9, 'en', 'Web design', 'web-design', NULL, '[]', 'Web design', NOW(), NOW()),
    (9, 'fa', 'طراحی وب‌سایت', 'web-design', NULL, '[]', 'طراحی وب‌سایت', NOW(), NOW()),
    (9, 'ar', 'تصميم المواقع', 'web-design', NULL, '[]', 'تصميم المواقع', NOW(), NOW()),
    (10, 'en', 'Web App development', 'web-app-development', NULL, '[]', 'Web App development', NOW(), NOW()),
    (10, 'fa', 'توسعهٔ اپلیکیشن تحت وب', 'web-app-development', NULL, '[]', 'توسعهٔ اپلیکیشن تحت وب', NOW(), NOW()),
    (10, 'ar', 'تطوير تطبيقات الويب', 'web-app-development', NULL, '[]', 'تطوير تطبيقات الويب', NOW(), NOW()),
    (11, 'en', 'Printing services', 'printing-services', NULL, '[]', NULL, NOW(), NOW()),
    (11, 'fa', 'خدمات چاپ', 'printing-services', NULL, '[]', NULL, NOW(), NOW()),
    (11, 'ar', 'خدمات الطباعة', 'printing-services', NULL, '[]', NULL, NOW(), NOW()),
    (12, 'en', 'Packaging design', 'packaging-design', NULL, '[]', NULL, NOW(), NOW()),
    (12, 'fa', 'طراحی بسته‌بندی', 'packaging-design', NULL, '[]', NULL, NOW(), NOW()),
    (12, 'ar', 'تصميم التغليف', 'packaging-design', NULL, '[]', NULL, NOW(), NOW()),
    (13, 'en', 'PR Campaigns', 'pr-campaigns', NULL, '[]', NULL, NOW(), NOW()),
    (13, 'fa', 'کمپین‌های روابط عمومی', 'pr-campaigns', NULL, '[]', NULL, NOW(), NOW()),
    (13, 'ar', 'حملات العلاقات العامة', 'pr-campaigns', NULL, '[]', NULL, NOW(), NOW()),
    (14, 'en', 'Video productions', 'video-productions', NULL, '[]', NULL, NOW(), NOW()),
    (14, 'fa', 'تولید ویدئو', 'video-productions', NULL, '[]', NULL, NOW(), NOW()),
    (14, 'ar', 'إنتاج الفيديو', 'video-productions', NULL, '[]', NULL, NOW(), NOW()),
    (15, 'en', 'Data science', 'data-science', NULL, '[]', NULL, NOW(), NOW()),
    (15, 'fa', 'علم داده', 'data-science', NULL, '[]', NULL, NOW(), NOW()),
    (15, 'ar', 'علوم البيانات', 'data-science', NULL, '[]', NULL, NOW(), NOW()),
    (16, 'en', 'Production planning', 'production-planning', NULL, '[]', NULL, NOW(), NOW()),
    (16, 'fa', 'برنامه‌ریزی تولید', 'production-planning', NULL, '[]', NULL, NOW(), NOW()),
    (16, 'ar', 'تخطيط الإنتاج', 'production-planning', NULL, '[]', NULL, NOW(), NOW()),
    (17, 'en', 'GTM strategy', 'gtm-strategy', NULL, '[]', NULL, NOW(), NOW()),
    (17, 'fa', 'استراتژی ورود به بازار', 'gtm-strategy', NULL, '[]', NULL, NOW(), NOW()),
    (17, 'ar', 'استراتيجية دخول السوق', 'gtm-strategy', NULL, '[]', NULL, NOW(), NOW()),
    (18, 'en', 'SMM', 'smm', NULL, '[]', NULL, NOW(), NOW()),
    (18, 'fa', 'بازاریابی شبکه‌های اجتماعی', 'smm', NULL, '[]', NULL, NOW(), NOW()),
    (18, 'ar', 'التسويق عبر وسائل التواصل', 'smm', NULL, '[]', NULL, NOW(), NOW()),
    (19, 'en', 'Product writing', 'product-writing', NULL, '[]', NULL, NOW(), NOW()),
    (19, 'fa', 'محتوانویسی محصول', 'product-writing', NULL, '[]', NULL, NOW(), NOW()),
    (19, 'ar', 'كتابة محتوى المنتجات', 'product-writing', NULL, '[]', NULL, NOW(), NOW())
ON DUPLICATE KEY UPDATE
    title = VALUES(title),
