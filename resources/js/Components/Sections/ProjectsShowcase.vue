        ...
        >
          ...
          >
            <button
              ...
              :key="project.slug"
              type="button"
              class="h-[10px] rounded-round transition-[width,background-color] duration-300 ease-out"
              :class="mobileActiveIndex === index ? 'w-5 bg-gold' : 'w-[10px] bg-neutral-300'"
          ...
          <div class="order-2 flex min-w-0 flex-col gap-6 lg:order-2">
            ...
            >
              <button
                ...
                type="button"
                class="h-[10px] rounded-round transition-[width,background-color] duration-300 ease-out"
                :class="activeIndex === index ? 'w-5 bg-gold hover:bg-gold' : 'w-[10px] bg-neutral-300 hover:bg-neutral-400'"
                :aria-label="`${index + 1}: ${project.title}`"
